...
def compute_forget_score_from_confs(unlearned_confs, retrained_confs):
  ...
  """
  logging.info(f"unlearned_confs shape: {unlearned_confs.shape}")
  logging.info(f"retrained_confs shape: {retrained_confs.shape}")
  ...
  logging.info(f"{pos_confs.shape}")
  logging.info(f"{neg_confs.shape}")
